...
<div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex-grow">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h1 class="text-2xl sm:text-xl font-bold text-gray-600 tracking-tight">
                    Flash Sale </h1>

            </div>

            <div class="w-full md:w-auto min-w-[200px]">
                <form method="GET" action="{{ route('shop-on-sale') }}" id="sortForm">
                    <div class="relative">
        ...
        <div class="flex-1">
            @if($flashSales && $flashSales->count() > 0)
