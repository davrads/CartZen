...
<div>
    <!-- category left block -->
    <div class="filter-sidebar mx-auto shadow-lg rounded-xl overflow-hidden">
    <!-- Categories -->
    <div>
      <div class="section-header">Categories</div>
      <div class="py-1">
        <div class="list-item active">All</div>
        <div class="list-item">Mobiles</div>
        <div class="list-item">Tablets</div>
    ...
    <div class="border-t border-gray-200">
      ...
      <div class="py-1">
        <label class="checkbox-label">
          <input type="checkbox" class="w-5 h-5 accent-violet-600">
          <span>Samsung</span>
        </label>
        <label class="checkbox-label">
          <input type="checkbox" class="w-5 h-5 accent-violet-600">
      ...
      <div class="px-6 pb-4">
        <button class="text-violet-600 hover:text-violet-700 text-sm font-medium flex items-center gap-1">
          Show more
    ...
    <!-- category detail page comes here -->
    <div>This page for gategory detail list</div>
</div>
</section>
