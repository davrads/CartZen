...
@section('content')
<div class="min-h-screen bg-gray-50 flex flex-col-reverse lg:flex-row">
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm"><span class="px-2 bg-white text-gray-500">Or register with</span></div>
                </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 hero-bg items-center justify-center p-12 relative overflow-hidden order-1 lg:order-2">
